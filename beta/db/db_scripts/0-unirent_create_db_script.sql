...
CREATE TABLE IF NOT EXISTS `u215407366_unir`.`Customer` (
  ...
  `newsletter` INT NULL,
  `EduacationEstablishment_id` INT NULL,
  `Course_id` INT NULL,
  `Address_id` INT NULL,
...
CREATE TABLE IF NOT EXISTS `u215407366_unir`.`Item` (
  ...
  INDEX `fk_Item_Address1_idx` (`Address_id` ASC),
...
-- -----------------------------------------------------
-- Table `u215407366_unir`.`Review`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `u215407366_unir`.`Review` ;

CREATE TABLE IF NOT EXISTS `u215407366_unir`.`Review` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `u215407366_unir`.`Lead`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `u215407366_unir`.`Lead` ;

CREATE TABLE IF NOT EXISTS `u215407366_unir`.`Lead` (
  `id` INT NOT NULL,
  `email` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
