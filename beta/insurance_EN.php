...
<?php
  ...
  do_unirent_header('Insurance - UniRent');
?>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
				<div class="pricingIntro">
					<p>We offer you the option to add an insurance to each rental you make, so you won't have to worry about any security deposit or statement of responsability to cover any eventuality that happens with the item you are renting.</p>
				</div>
			</div>
		</div>
		<div class="row">
				...
				<div class="priceTableWrapper advancedSupport">
					...
					<div class="priceInfo">
						<ul class="priceShorting">
							...
							<li><i class="fa fa-check-square"></i><p>Bond to Owner's Conditions:</p>
								<ul>
			...
			<div class="col-sm-6 col-xs-12">
				<div class="priceTableWrapper advancedSupport active">
					<div class="priceTableTitle">
						<h2>With Insurance<small>Without Concerns</small></h2>
					</div>
					<div class="priceAmount">
					...
					<div class="priceInfo">
						<ul class="priceShorting">
							...
							<li class="active"><i class="fa fa-check-square"></i><p>The Owner's Conditions have no effect:</p>
								<ul>
